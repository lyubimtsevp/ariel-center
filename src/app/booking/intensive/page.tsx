      ...
      <div className="max-w-4xl mx-auto">
        ...
        <FadeIn delay={0.2}>
          <div className="flex items-center gap-2 mb-8 overflow-x-auto pb-2">
            ...
            <div className="h-px w-4 flex-1 bg-gray-300"></div>
            <div className={`flex items-center gap-2 px-3 py-2 rounded-full whitespace-nowrap ${step === 'payment' ? 'bg-[#4A90A4] text-white' : 'bg-gray-200 text-gray-600'}`}>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              ...
              <label className="flex items-start gap-3 cursor-pointer group mb-6 p-4 bg-gray-50 rounded-xl">
                <input
                  ...
                  className="w-5 h-5 mt-0.5 text-[#4A90A4] rounded border-gray-300 focus:ring-[#4A90A4]"
                />
                <span className="text-gray-800 group-hover:text-[#4A90A4] transition font-medium">
